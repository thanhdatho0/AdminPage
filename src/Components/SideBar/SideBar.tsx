...
import { AiOutlineDashboard, AiOutlineUser, AiOutlineShoppingCart, AiOutlineTransaction, AiOutlineMenu } from 'react-icons/ai';
...
const SideBar = () => {
    ...
    return (
        <div>
            ...
            <button type={"button"} title={"menu-mobile-toggle-btn"}
            ...
            >
                ...
                <div className="flex flex-col items-center mb-6">
                    <div className="w-16 h-16 bg-gray-700 rounded-full mb-2"><img src={logo} alt="" className={"rounded-full"}/></div>
                ...
                <div className="space-y-4">
                    {/* Pages */}
                    <div>
                        <h3 className="text-gray-500 uppercase text-xs font-semibold mb-2">Pages</h3>
                        <ul className="space-y-2">
                            <Link to={'/dashboard'} className={"focus:bg-gray-700"}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                            ...
                            <Link to={'/products'}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                                    activeItem === 'products' ? 'bg-gray-700' : 'hover:bg-gray-700'
                                }`}
                            ...
                            <Link to={'/transactions'}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                                    activeItem === 'transactions' ? 'bg-gray-700' : 'hover:bg-gray-700'
                                }`}
                    ...
                    {/* Analytics */}
                    <div>
                        <h3 className="text-gray-500 uppercase text-xs font-semibold mb-2">Analytics</h3>
                        <ul className="space-y-2">
                            <Link to={'/revenue'}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                                    activeItem === 'revenue' ? 'bg-gray-700' : 'hover:bg-gray-700'
                                }`}
                            ...
                            <Link to={'/reports'}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                                    activeItem === 'reports' ? 'bg-gray-700' : 'hover:bg-gray-700'
                                }`}
                    ...
                    {/* User */}
                    <div>
                        <h3 className="text-gray-500 uppercase text-xs font-semibold mb-2">User</h3>
                        <ul className="space-y-2">
                            <Link to={'/settings'}>
                                <li className={`flex items-center p-2 rounded-md cursor-pointer ${
                                    activeItem === 'settings' ? 'bg-gray-700' : 'hover:bg-gray-700'
                                }`}
